...
const WHY = [
  [
    "Sized to your load",
    "We measure what you run, then quote only the panels, storage and inverter you need."
  ],
  [
    "Installed properly",
    "Certified technicians handle mounting, earthing and commissioning. You get a written warranty."
  ],
...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="cats">
          {CATEGORIES.map((c, i) => (
            <Reveal key={c} delay={i * 60}>
              <Link className={`cat cat-${i}`} to={`/products?cat=${encodeURIComponent(c)}`}>
                <span>{c}</span>
      ...
      <section className="band" aria-labelledby="feat">
        <div className="wrap pad">
          <div className="between">
            <h2 id="feat">Popular right now</h2>
      ...
      <section className="wrap pad">
        <div className="cta">
          ...
          <p>
            Send us your electricity bill or a list of appliances on WhatsApp. We reply with a
            recommended system and price.
          </p>
          <a
